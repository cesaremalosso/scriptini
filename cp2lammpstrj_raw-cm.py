...
def write_xyz(outfile, data, natoms_per_type, type_names=None, type_array=None, xyz = False, vel = False, charge = None, tskip = 1, vcm = False, raw = False, shuffle = False):
	"""
...
scrivi = write_xyz('{}.lammpstrj'.format(prefix), leggi, natm, species, type_array, xyz = xyz, vel = vel, charge=charge, tskip=tskip, vcm=vcm, raw=raw, shuffle=shuffle)
print('Done.')
